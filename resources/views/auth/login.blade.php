    ...
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form method="post" action="{{ route('login') }}"  novalidate>
                ...
                <div class="mb-5">
                    <label for="identificacion" class="mb-2 block uppercase text-gray-500 font-bold" >Identificación</label>
                    <input type="text" id="identificacion" name="identificacion" placeholder="Identificación" class="border p-3 w-full rounded-lg">
